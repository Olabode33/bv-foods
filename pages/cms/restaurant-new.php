	...
	<fieldset>		
		...
		?>
				<div class="form-group">
					...
					<div class="col-lg-4">
						<input type="file" name="logo" id="logo" class="form-control" value="<?php echo ((isset($_POST['r']))?$_POST['logo']:((isset($_GET['rid']))?$restaurant_info['logo']:''))?>">
						<span class="help-block">
					...
					<div class="col-lg-4">
						<input type="file" name="bg_image" id="bg_image" class="form-control" value="<?php echo ((isset($_POST['r']))?$_POST['bg_image']:((isset($_GET['rid']))?$restaurant_info['bg_image']:''))?>" >
						<span class="help-block">
